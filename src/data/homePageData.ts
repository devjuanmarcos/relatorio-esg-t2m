...
export const CallBannerData: CallBannerInterface = {
...
export const mensagemCeoData: ImageWithCardTextBannerInterface = {
...
export const sobreRelatorioData: TwoCardsTextBannerInterface = {
  firstBox: {
...
export const processoMaterialidadeData: SimpleCallBannerInterface = {
  alignment: "start",
  imageUrl: "/img/temp/Frame3.png",
...
export const partesInteressadasData: IconsCardsBannerInterface = {
...
export const metodologiaData: SimpleCallBannerInterface = {
  alignment: "end",
...
export const quatroCardsMetodologiaData: ThreeTextCardsWithNumberCardBannerInterface = {
  textCards: [
    {
      topTitle: "Revisão",
...
export const matrizMaterialidadeData: SimpleCallBannerInterface = {
  alignment: "start",
  topTitle: "Relatório",
...
export const matrizMaterialidadeTopicosData: ImageWithTopicsBannerInterface = {
  captions: [
    {
      color: "bg-[#51BFCC]",
